...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    date: "2026-08-12",
    changes: [
      "Публичный дашборд: статус-баннер, активные проблемы и строка «аптайм/обновлено» объединены в одну полосу; отдельный ряд счётчиков-фильтров убран",
      "Редактор страницы: действия над пробой (проверить/пауза/изменить/⋯) скрываются до наведения — список проб стал компактнее",
      "Wallboard: вместо трёх счётчиков — один крупный «N / всего», проблемные пробы показываются прямо в общей сетке с длительностью сбоя и кодом ошибки",
      "Список страниц в админке: колонки «Здоровье» и «Аптайм 24ч» по каждой странице",
    ],
  },
  {
    version: "1.13.0",
