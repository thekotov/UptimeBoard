...
const ru: Dict = {
  ...
  "wall.problemProbes": "проб с проблемами",
  "views.title": "Виды",
  ...
  "alerts.messageStyle": "Формат сообщения",
  "alerts.messageStyle.default": "Обычный",
  "alerts.messageStyle.defaultDesc": "Заголовок (статус, сервер, IP) + детали в раскрывающейся цитате",
  "alerts.messageStyle.compact": "Компакт",
  "alerts.messageStyle.compactDesc": "Одна строка — для чатов с активным общением",
  "alerts.messageStyle.table": "Таблица",
  "alerts.messageStyle.tableDesc": "Поля таблицей (Rich Message, экспериментально)",
  "alerts.messageStyleHint": "«Таблица» использует новый Telegram Rich Message API (sendRichMessage) — если бот/клиент его не поддерживает, алерт автоматически уходит в обычном виде.",
  "alerts.menuCommands": "Команды в чате",
  "alerts.menuCommandsEnable": "Включить /menu (статус, аптайм, health по кнопкам)",
  "alerts.menuCommandsHint": "Бот начинает отвечать на /menu и нажатия кнопок в этом чате. Требует настроенный PUBLIC_BASE_URL на сервере и заранее указанный ID чата — включение отключает у бота getUpdates (то есть «Подобрать chat_id» перестанет работать для этого бота).",
  "alerts.test": "Тест",
  ...
  "pages.yes": "да",
  "pages.no": "нет",
  "pages.health": "Здоровье",
  "pages.uptime24h": "Аптайм 24ч",
  ...
  "alerts.stormSettings": "Групповые алерты при шторме",
  "alerts.stormSettingsHint": "Если несколько серверов одного сервиса падают почти одновременно, первый алерт ненадолго задерживается, чтобы собрать остальных в одно сообщение вместо нескольких отдельных.",
  "alerts.stormEnabled": "Группировать при шторме",
  "alerts.stormWindowSec": "окно ожидания, сек",
  "alerts.stormResetDefault": "Сбросить на дефолт",
...
const en: Dict = {
  ...
  "wall.problemProbes": "probes with issues",
  "views.title": "Views",
  ...
  "alerts.messageStyle": "Message format",
  "alerts.messageStyle.default": "Default",
  "alerts.messageStyle.defaultDesc": "Headline (status, server, IP) + details in an expandable quote",
  "alerts.messageStyle.compact": "Compact",
  "alerts.messageStyle.compactDesc": "One line — for chats with active discussion",
  "alerts.messageStyle.table": "Table",
  "alerts.messageStyle.tableDesc": "Fields as a table (Rich Message, experimental)",
  "alerts.messageStyleHint": "\"Table\" uses Telegram's new Rich Message API (sendRichMessage) — if the bot/client doesn't support it, the alert automatically falls back to the regular format.",
  "alerts.menuCommands": "In-chat commands",
  "alerts.menuCommandsEnable": "Enable /menu (status, uptime, health via buttons)",
  "alerts.menuCommandsHint": "The bot starts responding to /menu and button taps in this chat. Requires PUBLIC_BASE_URL configured on the server and chat_id set first — enabling this disables the bot's getUpdates (so \"pick chat_id\" stops working for this bot).",
  "alerts.test": "Test",
  ...
  "alerts.stormSettings": "Storm-grouping alerts",
  "alerts.stormSettingsHint": "If several servers in the same service go down almost at once, the first alert is briefly delayed so the rest get folded into one combined message instead of several separate ones.",
  "alerts.stormEnabled": "Group storm alerts",
  "alerts.stormWindowSec": "wait window, sec",
  "alerts.stormResetDefault": "Reset to default",
