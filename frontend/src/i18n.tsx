...
const ru: Dict = {
  ...
  "probe.degradedThresholdHint": "После стольких неудачных проверок подряд проба становится жёлтой (degraded). 1 — сразу при первом сбое.",
  "probe.downThreshold": "Сбоев подряд до «down»",
  "probe.downThresholdHint": "После стольких неудачных проверок подряд проба становится красной (down). 1 — сразу при первом сбое.",
  "probe.test": "Тест",
...
const en: Dict = {
  ...
  "probe.degradedThresholdHint": "After this many consecutive failed checks the probe turns amber (degraded). 1 = on the first failure.",
  "probe.downThreshold": "Failures before “down”",
  "probe.downThresholdHint": "After this many consecutive failed checks the probe turns red (down). 1 = on the first failure.",
  "probe.test": "Test",
