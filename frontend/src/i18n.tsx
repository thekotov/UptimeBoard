...
const ru: Dict = {
  ...
  "alerts.messageStyle": "Тип уведомления",
  "alerts.messageStyle.default": "Обычный (текст с форматированием)",
  "alerts.messageStyle.table": "Таблица (Rich Message, экспериментально)",
...
const en: Dict = {
  ...
  "alerts.messageStyle": "Notification style",
  "alerts.messageStyle.default": "Default (formatted text)",
  "alerts.messageStyle.table": "Table (Rich Message, experimental)",
